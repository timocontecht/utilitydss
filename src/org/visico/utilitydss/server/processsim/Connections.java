...
{ 	
	...
	public Connections(Model owner, ParentProcess parent, String name, boolean showInTrace, double connection_duration_hwa, 
	...
	{	
		...
		switch(third_crew)
		{
			case 0:		// one or two crews available
			   ...
			   ActivityMessage msg_10 = new ActivityMessage(myModel, Parent, startConnection_2, "Housing pipe ", myModel.presentTime(), 5) ;
			   sendMessage(msg_10);
			   ...
			   ActivityMessage msg_11 = new ActivityMessage(myModel, Parent, startConnection_2, "Second Backfill ", myModel.presentTime(), 5);
			   sendMessage(msg_11);
			...
			case 1:		// third crew available to fill up trench
			   ...
			   myModel.secondcrews.provide(1);
			   hold (new TimeSpan((myModel.getHousingConnectionTime() * Connection_duration_hwa), TimeUnit.HOURS)); //multiply by this.NUM_CONNECTIONS or iterate trough them
			   ActivityMessage msg_13 = new ActivityMessage(myModel, Parent, startConnection_1, "Housing pipe ", myModel.presentTime(), 0) ;
			   sendMessage(msg_13);
